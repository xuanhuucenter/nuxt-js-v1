import { d as useRuntimeConfig, g as withLeadingSlash, j as joinURL, e as withoutTrailingSlash, t as withBase } from './server.mjs';
import { u as useRequestEvent, h as hash, a as useContentPreview } from './preview-B4lmiCwq.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-D_6ue11V.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-iIk03Za5.mjs.map
